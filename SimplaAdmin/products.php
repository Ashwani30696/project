...
if (isset($_GET['sku'])) {
    ...
    if ($_GET['action'] == 'delete') {
        $sql = "DELETE FROM products WHERE product_id=$sku";
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO products(`name`,price,`image`,category,tags,`description`) VALUES('$name','$price','$image','$categories','$q1','$description')";
    if (mysqli_query($conn, $sql)) {
