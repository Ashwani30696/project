		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div id="product-form">
                <form action="addProduct.php" method="POST">
                    ...
                    <br><br>
                    <label for="pprice">Product Price:<br></label>
                    ...
                    <label for="dis">Discription<br></label>
                    <textarea class="text-input textarea wysiwyg" id="textarea" name="short_desciption" cols="79" row="15"></textarea>
                    <br><br>
